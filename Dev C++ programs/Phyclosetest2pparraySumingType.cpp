...
int Dary[20] = {a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t};
int Stotal = Suma (Dary, 20);
if (Stotal > 14)
{
ofstream pfile;
pfile.open("phyResult2.txt");
{
...
pfile << " " << endl;
pfile << "Candidate missed number => " << m1 << "-" <<  m2 << "-" << m3 << "-" << m4 << "-" << m5 << "-" << m6 << "-" << m7 << "-" << m8 << "-" << m9 << "-" << m10 << "-" << m11 << "-" << m12 << "-" << m13 << "-" << m14 << "-" << m15 << "-" << m16 << "-" << m17 << "-" << m18 << "-" << m19 << "-" << m20 << endl;
pfile << " " << endl;
pfile << "Candidate got " << Stotal << " of 20" << endl;
pfile << "This is a very GOOD RESULT!!!" << endl;
pfile.close(); 
}
}
else if (Stotal < 10)
...
pfile << " " << endl;
pfile << "Candidate got " << Stotal << " of 20" << endl;
pfile << "This is a BAD RESULT!!!" << endl;
pfile.close();	
}
}
else 
...
pfile << " " << endl;
pfile << "Candidate got " << Stotal << " of 20" << endl;
pfile << "This is a GOOD RESULT!!!" << endl;
pfile.close();	
}
system ( "pause ");	
return 0;	
